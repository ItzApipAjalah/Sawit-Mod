    ...
    public static final RegistrySupplier<Item> SAWIT_FRUIT = ITEMS.register("sawit_fruit", () ->
            new Item(new Item.Properties().food(
                new net.minecraft.world.food.FoodProperties.Builder()
                    ...
                    .effect(new net.minecraft.world.effect.MobEffectInstance(net.minecraft.core.registries.BuiltInRegistries.MOB_EFFECT.wrapAsHolder(ModEffects.KOLESTROL.get()), 300, 0), 1.0f)
                    .build()
            )));
