...
public class ModVillagers {
    ...
    public static final RegistrySupplier<VillagerProfession> JURAGAN_SAWIT = VILLAGER_PROFESSIONS.register("juragan_sawit", () ->
            new VillagerProfession(net.minecraft.network.chat.Component.literal("juragan_sawit"),
    ...
    public static void register() {
        ...
        dev.architectury.event.events.common.LifecycleEvent.SETUP.register(() -> {
            try {
                ...
                java.util.Optional<net.minecraft.core.Holder.Reference<PoiType>> holderOpt = net.minecraft.core.registries.BuiltInRegistries.POINT_OF_INTEREST_TYPE.get(SAWIT_POI.getKey());
    ...
    static class BasicTrade implements VillagerTrades.ItemListing {
        ...
        public net.minecraft.world.item.trading.MerchantOffer getOffer(net.minecraft.server.level.ServerLevel serverLevel, net.minecraft.world.entity.Entity trader, net.minecraft.util.RandomSource random) {
    ...
    public static void registerTrades() {
        ...
        TradeRegistry.registerVillagerTrade(JURAGAN_SAWIT.getKey(), 1, 
        ...
        TradeRegistry.registerVillagerTrade(JURAGAN_SAWIT.getKey(), 2, 
        ...
        TradeRegistry.registerVillagerTrade(JURAGAN_SAWIT.getKey(), 3, 
