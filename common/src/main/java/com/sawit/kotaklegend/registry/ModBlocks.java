...
public class ModBlocks {
    ...
    public static final RegistrySupplier<Block> SAWIT_STAIRS = BLOCKS.register("sawit_stairs", () ->
            new net.minecraft.world.level.block.StairBlock(Blocks.OAK_PLANKS.defaultBlockState(), BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));

    public static final RegistrySupplier<Block> SAWIT_SLAB = BLOCKS.register("sawit_slab", () ->
            new net.minecraft.world.level.block.SlabBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));

    public static final RegistrySupplier<Block> SAWIT_FENCE = BLOCKS.register("sawit_fence", () ->
            new net.minecraft.world.level.block.FenceBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));

    public static final RegistrySupplier<Block> SAWIT_FENCE_GATE = BLOCKS.register("sawit_fence_gate", () ->
            new net.minecraft.world.level.block.FenceGateBlock(net.minecraft.world.level.block.state.properties.WoodType.OAK, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PLANKS)));

    public static final RegistrySupplier<Block> SAWIT_DOOR = BLOCKS.register("sawit_door", () ->
            new net.minecraft.world.level.block.DoorBlock(net.minecraft.world.level.block.state.properties.BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_DOOR)));

    public static final RegistrySupplier<Block> SAWIT_TRAPDOOR = BLOCKS.register("sawit_trapdoor", () ->
            new net.minecraft.world.level.block.TrapDoorBlock(net.minecraft.world.level.block.state.properties.BlockSetType.OAK, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_TRAPDOOR)));

    public static final RegistrySupplier<Block> SAWIT_BUTTON = BLOCKS.register("sawit_button", () ->
            new net.minecraft.world.level.block.ButtonBlock(net.minecraft.world.level.block.state.properties.BlockSetType.OAK, 30, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_BUTTON)));

    public static final RegistrySupplier<Block> SAWIT_PRESSURE_PLATE = BLOCKS.register("sawit_pressure_plate", () ->
            new net.minecraft.world.level.block.PressurePlateBlock(SAWIT_BLOCK_SET, BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_PRESSURE_PLATE)));

    public static final RegistrySupplier<Block> SAWIT_SIGN = BLOCKS.register("sawit_sign", () ->
            new com.sawit.kotaklegend.block.SawitStandingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_SIGN), SAWIT_WOOD_TYPE));

    public static final RegistrySupplier<Block> SAWIT_WALL_SIGN = BLOCKS.register("sawit_wall_sign", () ->
            new com.sawit.kotaklegend.block.SawitWallSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_SIGN), SAWIT_WOOD_TYPE));

    public static final RegistrySupplier<Block> SAWIT_HANGING_SIGN = BLOCKS.register("sawit_hanging_sign", () ->
            new com.sawit.kotaklegend.block.SawitHangingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_HANGING_SIGN), SAWIT_WOOD_TYPE));

    public static final RegistrySupplier<Block> SAWIT_WALL_HANGING_SIGN = BLOCKS.register("sawit_wall_hanging_sign", () ->
            new com.sawit.kotaklegend.block.SawitWallHangingSignBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.OAK_WALL_HANGING_SIGN), SAWIT_WOOD_TYPE));
