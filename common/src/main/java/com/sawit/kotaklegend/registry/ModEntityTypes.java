...
public class ModEntityTypes {
    ...
    public static final net.minecraft.resources.ResourceKey<EntityType<?>> SAWIT_BOAT_KEY = net.minecraft.resources.ResourceKey.create(Registries.ENTITY_TYPE, net.minecraft.resources.Identifier.fromNamespaceAndPath(ExampleMod.MOD_ID, "sawit_boat"));
    ...
    public static final net.minecraft.resources.ResourceKey<EntityType<?>> SAWIT_CHEST_BOAT_KEY = net.minecraft.resources.ResourceKey.create(Registries.ENTITY_TYPE, net.minecraft.resources.Identifier.fromNamespaceAndPath(ExampleMod.MOD_ID, "sawit_chest_boat"));
