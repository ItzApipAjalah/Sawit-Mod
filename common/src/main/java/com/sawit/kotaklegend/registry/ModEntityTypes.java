...
public class ModEntityTypes {
    ...
    public static final net.minecraft.resources.ResourceKey<EntityType<?>> SAWIT_BOAT_KEY = net.minecraft.resources.ResourceKey.create(Registries.ENTITY_TYPE, net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(ExampleMod.MOD_ID, "sawit_boat"));
    public static final RegistrySupplier<EntityType<SawitBoatEntity>> SAWIT_BOAT = ENTITY_TYPES.register("sawit_boat", () ->
            EntityType.Builder.<SawitBoatEntity>of(SawitBoatEntity::new, MobCategory.MISC)
                    ...
                    .build(SAWIT_BOAT_KEY));

    public static final net.minecraft.resources.ResourceKey<EntityType<?>> SAWIT_CHEST_BOAT_KEY = net.minecraft.resources.ResourceKey.create(Registries.ENTITY_TYPE, net.minecraft.resources.ResourceLocation.fromNamespaceAndPath(ExampleMod.MOD_ID, "sawit_chest_boat"));
