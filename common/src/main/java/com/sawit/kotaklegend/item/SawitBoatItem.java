    ...
    public net.minecraft.world.InteractionResult use(Level level, Player player, InteractionHand hand) {
        ...
        if (hitResult.getType() == HitResult.Type.MISS) {
            ...
            if (hitResult.getType() == HitResult.Type.BLOCK) {
                net.minecraft.world.entity.vehicle.AbstractBoat boat = this.hasChest ? new SawitChestBoatEntity(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z) : new SawitBoatEntity(level, hitResult.getLocation().x, hitResult.getLocation().y, hitResult.getLocation().z);
