...
public class SawitOilItem extends Item {
    ...
    @Override
    public void appendHoverText(ItemStack stack, net.minecraft.world.item.Item.TooltipContext level, List<Component> tooltipComponents, TooltipFlag isAdvanced) {
        if (isJelantah) {
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level level, net.minecraft.world.entity.LivingEntity entityLiving) {
        ...
        if (!level.isClientSide) {
            if (this.isJelantah) {
                ...
                entityLiving.addEffect(new net.minecraft.world.effect.MobEffectInstance(com.sawit.kotaklegend.registry.ModEffects.KOLESTROL, 6000, 0));
            }
        }
