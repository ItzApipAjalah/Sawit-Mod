...
public record SetBlockProperties(BlockItemStateProperties properties, Vec3i offset, Optional<Holder<GameEvent>> triggerGameEvent)
	...
	public SetBlockProperties(BlockItemStateProperties arg) {
		this(arg, Vec3i.ZERO, Optional.of(GameEvent.BLOCK_CHANGE));
	}
	...
	public void apply(ServerLevel arg, int i, EnchantedItemInUse arg2, Entity arg3, Vec3 arg4) {
		...
		BlockState blockState = arg3.level().getBlockState(blockPos);
		BlockState blockState2 = this.properties.apply(blockState);
		if (!blockState.equals(blockState2) && arg3.level().setBlock(blockPos, blockState2, 3)) {
