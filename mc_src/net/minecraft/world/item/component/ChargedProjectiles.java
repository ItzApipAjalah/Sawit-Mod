...
public final class ChargedProjectiles {
	...
	public static final Codec<ChargedProjectiles> CODEC = ItemStack.CODEC.listOf().xmap(ChargedProjectiles::new, arg -> arg.items);
	public static final StreamCodec<RegistryFriendlyByteBuf, ChargedProjectiles> STREAM_CODEC = ItemStack.STREAM_CODEC
		.apply(ByteBufCodecs.list())
		.map(ChargedProjectiles::new, arg -> arg.items);
	...
	public static ChargedProjectiles of(ItemStack arg) {
		return new ChargedProjectiles(List.of(arg.copy()));
	}
	...
	public boolean contains(Item arg) {
