...
public record SuspiciousStewEffects(List<SuspiciousStewEffects.Entry> effects) implements ConsumableListener, TooltipProvider {
	...
	public SuspiciousStewEffects withEffectAdded(SuspiciousStewEffects.Entry arg) {
		return new SuspiciousStewEffects(Util.copyAndAdd(this.effects, arg));
	}
	...
	public void onConsume(Level arg, LivingEntity arg2, ItemStack arg3, Consumable arg4) {
		for (SuspiciousStewEffects.Entry entry : this.effects) {
			arg2.addEffect(entry.createEffectInstance());
		}
	}
	...
	public void addToTooltip(Item.TooltipContext arg, Consumer<Component> consumer, TooltipFlag arg2) {
		if (arg2.isCreative()) {
			...
			PotionContents.addPotionTooltip(list, consumer, 1.0F, arg.tickRate());
		}
	}
