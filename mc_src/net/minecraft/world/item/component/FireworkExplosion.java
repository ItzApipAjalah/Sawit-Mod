...
public record FireworkExplosion(FireworkExplosion.Shape shape, IntList colors, IntList fadeColors, boolean hasTrail, boolean hasTwinkle)
	...
	private static Component appendColors(MutableComponent arg, IntList intList) {
		for (int i = 0; i < intList.size(); i++) {
			if (i > 0) {
				arg.append(", ");
			}

			arg.append(getColorName(intList.getInt(i)));
		}
	...
	@IndexedEnum
	@NamedEnum(1)
	public static enum Shape implements StringRepresentable, IExtensibleEnum {
