...
public record ItemLore(List<Component> lines, List<Component> styledLines) implements TooltipProvider {
	...
	public ItemLore(List<Component> list) {
		this(list, Lists.transform(list, arg -> ComponentUtils.mergeStyles(arg.copy(), LORE_STYLE)));
	}
	...
	public ItemLore withLineAdded(Component arg) {
		return new ItemLore(Util.copyAndAdd(this.lines, arg));
	}
