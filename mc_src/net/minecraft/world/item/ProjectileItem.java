...
public interface ProjectileItem {
	Projectile asProjectile(Level arg, Position arg2, ItemStack arg3, Direction arg4);

	default ProjectileItem.DispenseConfig createDispenseConfig() {
		return ProjectileItem.DispenseConfig.DEFAULT;
	}

	default void shoot(Projectile arg, double d, double e, double f, float g, float h) {
		arg.shoot(d, e, f, g, h);
	}
	...
	public record DispenseConfig(ProjectileItem.PositionFunction positionFunction, float uncertainty, float power, OptionalInt overrideDispenseEvent) {
		...
		public static class Builder {
			private ProjectileItem.PositionFunction positionFunction = (arg, arg2) -> DispenserBlock.getDispensePosition(arg, 0.7, new Vec3(0.0, 0.1, 0.0));
			private float uncertainty = 6.0F;
			private float power = 1.1F;
			private OptionalInt overrideDispenseEvent = OptionalInt.empty();

			public ProjectileItem.DispenseConfig.Builder positionFunction(ProjectileItem.PositionFunction arg) {
				this.positionFunction = arg;
				return this;
			}
	...
	public interface PositionFunction {
		Position getDispensePosition(BlockSource arg, Direction arg2);
	}
}
