...
public record JukeboxSong(Holder<SoundEvent> soundEvent, Component description, float lengthInSeconds, int comparatorOutput) {
	...
	public static Optional<Holder<JukeboxSong>> fromStack(HolderLookup.Provider arg, ItemStack arg2) {
		JukeboxPlayable jukeboxPlayable = arg2.get(DataComponents.JUKEBOX_PLAYABLE);
		return jukeboxPlayable != null ? jukeboxPlayable.song().unwrap(arg) : Optional.empty();
	}
}
