...
public abstract class AbstractCookingRecipe extends SingleItemRecipe {
	...
	public AbstractCookingRecipe(String string, CookingBookCategory arg, Ingredient arg2, ItemStack arg3, float f, int i) {
		super(string, arg2, arg3);
		this.category = arg;
		this.experience = f;
		this.cookingTime = i;
	}
	...
	public interface Factory<T extends AbstractCookingRecipe> {
		T create(String string, CookingBookCategory arg, Ingredient arg2, ItemStack arg3, float f, int i);
	}
	...
	public static class Serializer<T extends AbstractCookingRecipe> implements RecipeSerializer<T> {
		...
		public Serializer(AbstractCookingRecipe.Factory<T> arg, int i) {
