...
public class RecipeMap {
	...
	public <I extends RecipeInput, T extends Recipe<I>> Collection<RecipeHolder<T>> byType(RecipeType<T> arg) {
		return (Collection<RecipeHolder<T>>)this.byType.get(arg);
	}
	...
	@Nullable
	public RecipeHolder<?> byKey(ResourceKey<Recipe<?>> arg) {
		return (RecipeHolder<?>)this.byKey.get(arg);
	}

	public <I extends RecipeInput, T extends Recipe<I>> Stream<RecipeHolder<T>> getRecipesFor(RecipeType<T> arg, I arg2, Level arg3) {
		return arg2.isEmpty() ? Stream.empty() : this.byType(arg).stream().filter(arg3x -> arg3x.value().matches(arg2, arg3));
	}
}
