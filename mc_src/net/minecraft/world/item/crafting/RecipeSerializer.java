...
public interface RecipeSerializer<T extends Recipe<?>> {
	...
	static <S extends RecipeSerializer<T>, T extends Recipe<?>> S register(String string, S arg) {
		return Registry.register(BuiltInRegistries.RECIPE_SERIALIZER, string, (S)arg);
	}
}
