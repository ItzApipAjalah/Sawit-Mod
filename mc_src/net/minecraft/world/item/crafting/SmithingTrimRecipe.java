...
public class SmithingTrimRecipe implements SmithingRecipe {
	...
	public ItemStack assemble(SmithingRecipeInput arg, HolderLookup.Provider arg2) {
		return applyTrim(arg2, arg.base(), arg.addition(), arg.template());
	}

	public static ItemStack applyTrim(HolderLookup.Provider arg, ItemStack arg2, ItemStack arg3, ItemStack arg4) {
		Optional<Holder.Reference<TrimMaterial>> optional = TrimMaterials.getFromIngredient(arg, arg3);
		Optional<Holder.Reference<TrimPattern>> optional2 = TrimPatterns.getFromTemplate(arg, arg4);
		if (optional.isPresent() && optional2.isPresent()) {
			ArmorTrim armorTrim = arg2.get(DataComponents.TRIM);
			if (armorTrim != null && armorTrim.hasPatternAndMaterial((Holder<TrimPattern>)optional2.get(), (Holder<TrimMaterial>)optional.get())) {
				return ItemStack.EMPTY;
			} else {
				ItemStack itemStack = arg2.copyWithCount(1);
				itemStack.set(DataComponents.TRIM, new ArmorTrim((Holder<TrimMaterial>)optional.get(), (Holder<TrimPattern>)optional2.get()));
				return itemStack;
			}
		} else {
			return ItemStack.EMPTY;
