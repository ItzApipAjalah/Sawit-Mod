...
public record RecipeDisplayEntry(
	...
	public List<ItemStack> resultItems(ContextMap arg) {
		return this.display.result().resolveForStacks(arg);
	}

	public boolean canCraft(StackedItemContents arg) {
