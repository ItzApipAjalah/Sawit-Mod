...
public class SlotDisplayContext {
	...
	public static ContextMap fromLevel(Level arg) {
		return new ContextMap.Builder().withParameter(FUEL_VALUES, arg.fuelValues()).withParameter(REGISTRIES, arg.registryAccess()).create(CONTEXT);
	}
}
