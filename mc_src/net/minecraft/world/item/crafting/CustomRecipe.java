...
public abstract class CustomRecipe implements CraftingRecipe {
	...
	public CustomRecipe(CraftingBookCategory arg) {
		this.category = arg;
	}
	...
	public static class Serializer<T extends CraftingRecipe> implements RecipeSerializer<T> {
		...
		public Serializer(CustomRecipe.Serializer.Factory<T> arg) {
			...
			this.streamCodec = StreamCodec.composite(CraftingBookCategory.STREAM_CODEC, CraftingRecipe::category, arg::create);
		}
		...
		public interface Factory<T extends CraftingRecipe> {
			T create(CraftingBookCategory arg);
		}
	}
}
