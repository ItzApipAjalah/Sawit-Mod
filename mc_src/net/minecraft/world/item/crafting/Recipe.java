...
public interface Recipe<T extends RecipeInput> {
	...
	Codec<Optional<WithConditions<Recipe<?>>>> CONDITIONAL_CODEC = ConditionalOps.createConditionalCodecWithConditions(CODEC);
	...
	boolean matches(T arg, Level arg2);

	ItemStack assemble(T arg, HolderLookup.Provider arg2);
