...
public class SmithingTemplateItem extends Item {
	...
	public SmithingTemplateItem(
		Component arg, Component arg2, Component arg3, Component arg4, List<ResourceLocation> list, List<ResourceLocation> list2, Item.Properties arg5
	) {
		super(arg5);
		this.appliesTo = arg;
		this.ingredients = arg2;
		this.baseSlotDescription = arg3;
		this.additionsSlotDescription = arg4;
		this.baseSlotEmptyIcons = list;
		this.additionalSlotEmptyIcons = list2;
	}

	public static SmithingTemplateItem createArmorTrimTemplate(Item.Properties arg) {
	...
	public static SmithingTemplateItem createNetheriteUpgradeTemplate(Item.Properties arg) {
		return new SmithingTemplateItem(
