...
public class ShovelItem extends DiggerItem {
	...
	public ShovelItem(ToolMaterial arg, float f, float g, Item.Properties arg2) {
		super(arg, BlockTags.MINEABLE_WITH_SHOVEL, f, g, arg2);
	}
	...
	public InteractionResult useOn(UseOnContext arg) {
		...
		if (arg.getClickedFace() == Direction.DOWN) {
			return InteractionResult.PASS;
		} else {
			Player player = arg.getPlayer();
			BlockState blockstate1 = blockstate.getToolModifiedState(arg, ItemAbilities.SHOVEL_FLATTEN, false);
			BlockState blockstate2 = null;
			if (blockstate1 != null && level.getBlockState(blockpos.above()).isAir()) {
				level.playSound(player, blockpos, SoundEvents.SHOVEL_FLATTEN, SoundSource.BLOCKS, 1.0F, 1.0F);
				blockstate2 = blockstate1;
			} else if ((blockstate2 = blockstate.getToolModifiedState(arg, ItemAbilities.SHOVEL_DOUSE, false)) != null && !level.isClientSide()) {
