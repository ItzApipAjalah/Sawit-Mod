...
public class Items {
	...
	public static final Item CHISELED_BOOKSHELF = registerBlock(
		Blocks.CHISELED_BOOKSHELF, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	...
	public static final Item TORCH = registerBlock(
		Blocks.TORCH, (BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.WALL_TORCH, Direction.DOWN, arg2))
	);
	...
	public static final Item CHEST = registerBlock(
		Blocks.CHEST, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	...
	public static final Item FURNACE = registerBlock(
		Blocks.FURNACE, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	...
	public static final Item CARVED_PUMPKIN = registerBlock(
		...
		(UnaryOperator<Item.Properties>)(arg -> arg.component(
	...
	public static final Item SOUL_TORCH = registerBlock(
		Blocks.SOUL_TORCH, (BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.SOUL_WALL_TORCH, Direction.DOWN, arg2))
	);
	...
	public static final Item WHITE_CARPET = registerBlock(
		Blocks.WHITE_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.WHITE)))
	);
	public static final Item ORANGE_CARPET = registerBlock(
		Blocks.ORANGE_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.ORANGE)))
	);
	public static final Item MAGENTA_CARPET = registerBlock(
		Blocks.MAGENTA_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.MAGENTA)))
	);
	public static final Item LIGHT_BLUE_CARPET = registerBlock(
		Blocks.LIGHT_BLUE_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_BLUE)))
	);
	public static final Item YELLOW_CARPET = registerBlock(
		Blocks.YELLOW_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.YELLOW)))
	);
	public static final Item LIME_CARPET = registerBlock(
		Blocks.LIME_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIME)))
	);
	public static final Item PINK_CARPET = registerBlock(
		Blocks.PINK_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PINK)))
	);
	public static final Item GRAY_CARPET = registerBlock(
		Blocks.GRAY_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GRAY)))
	);
	public static final Item LIGHT_GRAY_CARPET = registerBlock(
		Blocks.LIGHT_GRAY_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.LIGHT_GRAY)))
	);
	public static final Item CYAN_CARPET = registerBlock(
		Blocks.CYAN_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.CYAN)))
	);
	public static final Item PURPLE_CARPET = registerBlock(
		Blocks.PURPLE_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.PURPLE)))
	);
	public static final Item BLUE_CARPET = registerBlock(
		Blocks.BLUE_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLUE)))
	);
	public static final Item BROWN_CARPET = registerBlock(
		Blocks.BROWN_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BROWN)))
	);
	public static final Item GREEN_CARPET = registerBlock(
		Blocks.GREEN_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.GREEN)))
	);
	public static final Item RED_CARPET = registerBlock(
		Blocks.RED_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.RED)))
	);
	public static final Item BLACK_CARPET = registerBlock(
		Blocks.BLACK_CARPET, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.EQUIPPABLE, Equippable.llamaSwag(DyeColor.BLACK)))
	);
	...
	public static final Item SNIFFER_EGG = registerBlock(Blocks.SNIFFER_EGG, (UnaryOperator<Item.Properties>)(arg -> arg.rarity(Rarity.UNCOMMON)));
	...
	public static final Item TUBE_CORAL_FAN = registerBlock(
		...
		(BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.TUBE_CORAL_WALL_FAN, Direction.DOWN, arg2))
	);
	public static final Item BRAIN_CORAL_FAN = registerBlock(
		Blocks.BRAIN_CORAL_FAN,
		(BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.BRAIN_CORAL_WALL_FAN, Direction.DOWN, arg2))
	);
	public static final Item BUBBLE_CORAL_FAN = registerBlock(
		Blocks.BUBBLE_CORAL_FAN,
		(BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.BUBBLE_CORAL_WALL_FAN, Direction.DOWN, arg2))
	);
	public static final Item FIRE_CORAL_FAN = registerBlock(
		Blocks.FIRE_CORAL_FAN,
		(BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.FIRE_CORAL_WALL_FAN, Direction.DOWN, arg2))
	);
	public static final Item HORN_CORAL_FAN = registerBlock(
		Blocks.HORN_CORAL_FAN,
		(BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.HORN_CORAL_WALL_FAN, Direction.DOWN, arg2))
	);
	public static final Item DEAD_TUBE_CORAL_FAN = registerBlock(
		Blocks.DEAD_TUBE_CORAL_FAN,
		(BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.DEAD_TUBE_CORAL_WALL_FAN, Direction.DOWN, arg2))
	);
	public static final Item DEAD_BRAIN_CORAL_FAN = registerBlock(
		Blocks.DEAD_BRAIN_CORAL_FAN,
		(BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.DEAD_BRAIN_CORAL_WALL_FAN, Direction.DOWN, arg2))
	);
	public static final Item DEAD_BUBBLE_CORAL_FAN = registerBlock(
		Blocks.DEAD_BUBBLE_CORAL_FAN,
		(BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.DEAD_BUBBLE_CORAL_WALL_FAN, Direction.DOWN, arg2))
	);
	public static final Item DEAD_FIRE_CORAL_FAN = registerBlock(
		Blocks.DEAD_FIRE_CORAL_FAN,
		(BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.DEAD_FIRE_CORAL_WALL_FAN, Direction.DOWN, arg2))
	);
	public static final Item DEAD_HORN_CORAL_FAN = registerBlock(
		Blocks.DEAD_HORN_CORAL_FAN,
		(BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.DEAD_HORN_CORAL_WALL_FAN, Direction.DOWN, arg2))
	);
	...
	public static final Item REDSTONE_TORCH = registerBlock(
		...
		(BiFunction<Block, Item.Properties, Item>)((arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.REDSTONE_WALL_TORCH, Direction.DOWN, arg2))
	);
	...
	public static final Item HOPPER = registerBlock(
		Blocks.HOPPER, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	public static final Item DISPENSER = registerBlock(
		Blocks.DISPENSER, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	public static final Item DROPPER = registerBlock(
		Blocks.DROPPER, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	...
	public static final Item TRAPPED_CHEST = registerBlock(
		Blocks.TRAPPED_CHEST, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	...
	public static final Item MINECART = registerItem("minecart", arg -> new MinecartItem(EntityType.MINECART, arg), new Item.Properties().stacksTo(1));
	public static final Item CHEST_MINECART = registerItem(
		"chest_minecart", arg -> new MinecartItem(EntityType.CHEST_MINECART, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item FURNACE_MINECART = registerItem(
		"furnace_minecart", arg -> new MinecartItem(EntityType.FURNACE_MINECART, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item TNT_MINECART = registerItem("tnt_minecart", arg -> new MinecartItem(EntityType.TNT_MINECART, arg), new Item.Properties().stacksTo(1));
	public static final Item HOPPER_MINECART = registerItem(
		"hopper_minecart", arg -> new MinecartItem(EntityType.HOPPER_MINECART, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item CARROT_ON_A_STICK = registerItem(
		"carrot_on_a_stick", arg -> new FoodOnAStickItem<>(EntityType.PIG, 7, arg), new Item.Properties().durability(25)
	);
	public static final Item WARPED_FUNGUS_ON_A_STICK = registerItem(
		"warped_fungus_on_a_stick", arg -> new FoodOnAStickItem<>(EntityType.STRIDER, 1, arg), new Item.Properties().durability(100)
	);
	...
	public static final Item OAK_BOAT = registerItem("oak_boat", arg -> new BoatItem(EntityType.OAK_BOAT, arg), new Item.Properties().stacksTo(1));
	public static final Item OAK_CHEST_BOAT = registerItem(
		"oak_chest_boat", arg -> new BoatItem(EntityType.OAK_CHEST_BOAT, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item SPRUCE_BOAT = registerItem("spruce_boat", arg -> new BoatItem(EntityType.SPRUCE_BOAT, arg), new Item.Properties().stacksTo(1));
	public static final Item SPRUCE_CHEST_BOAT = registerItem(
		"spruce_chest_boat", arg -> new BoatItem(EntityType.SPRUCE_CHEST_BOAT, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item BIRCH_BOAT = registerItem("birch_boat", arg -> new BoatItem(EntityType.BIRCH_BOAT, arg), new Item.Properties().stacksTo(1));
	public static final Item BIRCH_CHEST_BOAT = registerItem(
		"birch_chest_boat", arg -> new BoatItem(EntityType.BIRCH_CHEST_BOAT, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item JUNGLE_BOAT = registerItem("jungle_boat", arg -> new BoatItem(EntityType.JUNGLE_BOAT, arg), new Item.Properties().stacksTo(1));
	public static final Item JUNGLE_CHEST_BOAT = registerItem(
		"jungle_chest_boat", arg -> new BoatItem(EntityType.JUNGLE_CHEST_BOAT, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item ACACIA_BOAT = registerItem("acacia_boat", arg -> new BoatItem(EntityType.ACACIA_BOAT, arg), new Item.Properties().stacksTo(1));
	public static final Item ACACIA_CHEST_BOAT = registerItem(
		"acacia_chest_boat", arg -> new BoatItem(EntityType.ACACIA_CHEST_BOAT, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item CHERRY_BOAT = registerItem("cherry_boat", arg -> new BoatItem(EntityType.CHERRY_BOAT, arg), new Item.Properties().stacksTo(1));
	public static final Item CHERRY_CHEST_BOAT = registerItem(
		"cherry_chest_boat", arg -> new BoatItem(EntityType.CHERRY_CHEST_BOAT, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item DARK_OAK_BOAT = registerItem("dark_oak_boat", arg -> new BoatItem(EntityType.DARK_OAK_BOAT, arg), new Item.Properties().stacksTo(1));
	public static final Item DARK_OAK_CHEST_BOAT = registerItem(
		"dark_oak_chest_boat", arg -> new BoatItem(EntityType.DARK_OAK_CHEST_BOAT, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item PALE_OAK_BOAT = registerItem(
		"pale_oak_boat", arg -> new BoatItem(EntityType.PALE_OAK_BOAT, arg), new Item.Properties().stacksTo(1).requiredFeatures(FeatureFlags.WINTER_DROP)
	);
	public static final Item PALE_OAK_CHEST_BOAT = registerItem(
		"pale_oak_chest_boat", arg -> new BoatItem(EntityType.PALE_OAK_CHEST_BOAT, arg), new Item.Properties().stacksTo(1).requiredFeatures(FeatureFlags.WINTER_DROP)
	);
	public static final Item MANGROVE_BOAT = registerItem("mangrove_boat", arg -> new BoatItem(EntityType.MANGROVE_BOAT, arg), new Item.Properties().stacksTo(1));
	public static final Item MANGROVE_CHEST_BOAT = registerItem(
		"mangrove_chest_boat", arg -> new BoatItem(EntityType.MANGROVE_CHEST_BOAT, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item BAMBOO_RAFT = registerItem("bamboo_raft", arg -> new BoatItem(EntityType.BAMBOO_RAFT, arg), new Item.Properties().stacksTo(1));
	public static final Item BAMBOO_CHEST_RAFT = registerItem(
		"bamboo_chest_raft", arg -> new BoatItem(EntityType.BAMBOO_CHEST_RAFT, arg), new Item.Properties().stacksTo(1)
	);
	...
	public static final Item TURTLE_HELMET = registerItem("turtle_helmet", arg -> new ArmorItem(ArmorMaterials.TURTLE_SCUTE, ArmorType.HELMET, arg));
	...
	public static final Item WOLF_ARMOR = registerItem(
		"wolf_armor", arg -> new AnimalArmorItem(ArmorMaterials.ARMADILLO_SCUTE, AnimalArmorItem.BodyType.CANINE, arg)
	);
	...
	public static final Item WOODEN_SWORD = registerItem("wooden_sword", arg -> new SwordItem(ToolMaterial.WOOD, 3.0F, -2.4F, arg));
	public static final Item WOODEN_SHOVEL = registerItem("wooden_shovel", arg -> new ShovelItem(ToolMaterial.WOOD, 1.5F, -3.0F, arg));
	public static final Item WOODEN_PICKAXE = registerItem("wooden_pickaxe", arg -> new PickaxeItem(ToolMaterial.WOOD, 1.0F, -2.8F, arg));
	public static final Item WOODEN_AXE = registerItem("wooden_axe", arg -> new AxeItem(ToolMaterial.WOOD, 6.0F, -3.2F, arg));
	public static final Item WOODEN_HOE = registerItem("wooden_hoe", arg -> new HoeItem(ToolMaterial.WOOD, 0.0F, -3.0F, arg));
	public static final Item STONE_SWORD = registerItem("stone_sword", arg -> new SwordItem(ToolMaterial.STONE, 3.0F, -2.4F, arg));
	public static final Item STONE_SHOVEL = registerItem("stone_shovel", arg -> new ShovelItem(ToolMaterial.STONE, 1.5F, -3.0F, arg));
	public static final Item STONE_PICKAXE = registerItem("stone_pickaxe", arg -> new PickaxeItem(ToolMaterial.STONE, 1.0F, -2.8F, arg));
	public static final Item STONE_AXE = registerItem("stone_axe", arg -> new AxeItem(ToolMaterial.STONE, 7.0F, -3.2F, arg));
	public static final Item STONE_HOE = registerItem("stone_hoe", arg -> new HoeItem(ToolMaterial.STONE, -1.0F, -2.0F, arg));
	public static final Item GOLDEN_SWORD = registerItem("golden_sword", arg -> new SwordItem(ToolMaterial.GOLD, 3.0F, -2.4F, arg));
	public static final Item GOLDEN_SHOVEL = registerItem("golden_shovel", arg -> new ShovelItem(ToolMaterial.GOLD, 1.5F, -3.0F, arg));
	public static final Item GOLDEN_PICKAXE = registerItem("golden_pickaxe", arg -> new PickaxeItem(ToolMaterial.GOLD, 1.0F, -2.8F, arg));
	public static final Item GOLDEN_AXE = registerItem("golden_axe", arg -> new AxeItem(ToolMaterial.GOLD, 6.0F, -3.0F, arg));
	public static final Item GOLDEN_HOE = registerItem("golden_hoe", arg -> new HoeItem(ToolMaterial.GOLD, 0.0F, -3.0F, arg));
	public static final Item IRON_SWORD = registerItem("iron_sword", arg -> new SwordItem(ToolMaterial.IRON, 3.0F, -2.4F, arg));
	public static final Item IRON_SHOVEL = registerItem("iron_shovel", arg -> new ShovelItem(ToolMaterial.IRON, 1.5F, -3.0F, arg));
	public static final Item IRON_PICKAXE = registerItem("iron_pickaxe", arg -> new PickaxeItem(ToolMaterial.IRON, 1.0F, -2.8F, arg));
	public static final Item IRON_AXE = registerItem("iron_axe", arg -> new AxeItem(ToolMaterial.IRON, 6.0F, -3.1F, arg));
	public static final Item IRON_HOE = registerItem("iron_hoe", arg -> new HoeItem(ToolMaterial.IRON, -2.0F, -1.0F, arg));
	public static final Item DIAMOND_SWORD = registerItem("diamond_sword", arg -> new SwordItem(ToolMaterial.DIAMOND, 3.0F, -2.4F, arg));
	public static final Item DIAMOND_SHOVEL = registerItem("diamond_shovel", arg -> new ShovelItem(ToolMaterial.DIAMOND, 1.5F, -3.0F, arg));
	public static final Item DIAMOND_PICKAXE = registerItem("diamond_pickaxe", arg -> new PickaxeItem(ToolMaterial.DIAMOND, 1.0F, -2.8F, arg));
	public static final Item DIAMOND_AXE = registerItem("diamond_axe", arg -> new AxeItem(ToolMaterial.DIAMOND, 5.0F, -3.0F, arg));
	public static final Item DIAMOND_HOE = registerItem("diamond_hoe", arg -> new HoeItem(ToolMaterial.DIAMOND, -3.0F, 0.0F, arg));
	public static final Item NETHERITE_SWORD = registerItem(
		"netherite_sword", arg -> new SwordItem(ToolMaterial.NETHERITE, 3.0F, -2.4F, arg), new Item.Properties().fireResistant()
	);
	public static final Item NETHERITE_SHOVEL = registerItem(
		"netherite_shovel", arg -> new ShovelItem(ToolMaterial.NETHERITE, 1.5F, -3.0F, arg), new Item.Properties().fireResistant()
	);
	public static final Item NETHERITE_PICKAXE = registerItem(
		"netherite_pickaxe", arg -> new PickaxeItem(ToolMaterial.NETHERITE, 1.0F, -2.8F, arg), new Item.Properties().fireResistant()
	);
	public static final Item NETHERITE_AXE = registerItem(
		"netherite_axe", arg -> new AxeItem(ToolMaterial.NETHERITE, 5.0F, -3.0F, arg), new Item.Properties().fireResistant()
	);
	public static final Item NETHERITE_HOE = registerItem(
		"netherite_hoe", arg -> new HoeItem(ToolMaterial.NETHERITE, -4.0F, 0.0F, arg), new Item.Properties().fireResistant()
	);
	...
	public static final Item LEATHER_HELMET = registerItem("leather_helmet", arg -> new ArmorItem(ArmorMaterials.LEATHER, ArmorType.HELMET, arg));
	public static final Item LEATHER_CHESTPLATE = registerItem("leather_chestplate", arg -> new ArmorItem(ArmorMaterials.LEATHER, ArmorType.CHESTPLATE, arg));
	public static final Item LEATHER_LEGGINGS = registerItem("leather_leggings", arg -> new ArmorItem(ArmorMaterials.LEATHER, ArmorType.LEGGINGS, arg));
	public static final Item LEATHER_BOOTS = registerItem("leather_boots", arg -> new ArmorItem(ArmorMaterials.LEATHER, ArmorType.BOOTS, arg));
	public static final Item CHAINMAIL_HELMET = registerItem(
		"chainmail_helmet", arg -> new ArmorItem(ArmorMaterials.CHAINMAIL, ArmorType.HELMET, arg), new Item.Properties().rarity(Rarity.UNCOMMON)
	);
	public static final Item CHAINMAIL_CHESTPLATE = registerItem(
		"chainmail_chestplate", arg -> new ArmorItem(ArmorMaterials.CHAINMAIL, ArmorType.CHESTPLATE, arg), new Item.Properties().rarity(Rarity.UNCOMMON)
	);
	public static final Item CHAINMAIL_LEGGINGS = registerItem(
		"chainmail_leggings", arg -> new ArmorItem(ArmorMaterials.CHAINMAIL, ArmorType.LEGGINGS, arg), new Item.Properties().rarity(Rarity.UNCOMMON)
	);
	public static final Item CHAINMAIL_BOOTS = registerItem(
		"chainmail_boots", arg -> new ArmorItem(ArmorMaterials.CHAINMAIL, ArmorType.BOOTS, arg), new Item.Properties().rarity(Rarity.UNCOMMON)
	);
	public static final Item IRON_HELMET = registerItem("iron_helmet", arg -> new ArmorItem(ArmorMaterials.IRON, ArmorType.HELMET, arg));
	public static final Item IRON_CHESTPLATE = registerItem("iron_chestplate", arg -> new ArmorItem(ArmorMaterials.IRON, ArmorType.CHESTPLATE, arg));
	public static final Item IRON_LEGGINGS = registerItem("iron_leggings", arg -> new ArmorItem(ArmorMaterials.IRON, ArmorType.LEGGINGS, arg));
	public static final Item IRON_BOOTS = registerItem("iron_boots", arg -> new ArmorItem(ArmorMaterials.IRON, ArmorType.BOOTS, arg));
	public static final Item DIAMOND_HELMET = registerItem("diamond_helmet", arg -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorType.HELMET, arg));
	public static final Item DIAMOND_CHESTPLATE = registerItem("diamond_chestplate", arg -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorType.CHESTPLATE, arg));
	public static final Item DIAMOND_LEGGINGS = registerItem("diamond_leggings", arg -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorType.LEGGINGS, arg));
	public static final Item DIAMOND_BOOTS = registerItem("diamond_boots", arg -> new ArmorItem(ArmorMaterials.DIAMOND, ArmorType.BOOTS, arg));
	public static final Item GOLDEN_HELMET = registerItem("golden_helmet", arg -> new ArmorItem(ArmorMaterials.GOLD, ArmorType.HELMET, arg));
	public static final Item GOLDEN_CHESTPLATE = registerItem("golden_chestplate", arg -> new ArmorItem(ArmorMaterials.GOLD, ArmorType.CHESTPLATE, arg));
	public static final Item GOLDEN_LEGGINGS = registerItem("golden_leggings", arg -> new ArmorItem(ArmorMaterials.GOLD, ArmorType.LEGGINGS, arg));
	public static final Item GOLDEN_BOOTS = registerItem("golden_boots", arg -> new ArmorItem(ArmorMaterials.GOLD, ArmorType.BOOTS, arg));
	public static final Item NETHERITE_HELMET = registerItem(
		"netherite_helmet", arg -> new ArmorItem(ArmorMaterials.NETHERITE, ArmorType.HELMET, arg), new Item.Properties().fireResistant()
	);
	public static final Item NETHERITE_CHESTPLATE = registerItem(
		"netherite_chestplate", arg -> new ArmorItem(ArmorMaterials.NETHERITE, ArmorType.CHESTPLATE, arg), new Item.Properties().fireResistant()
	);
	public static final Item NETHERITE_LEGGINGS = registerItem(
		"netherite_leggings", arg -> new ArmorItem(ArmorMaterials.NETHERITE, ArmorType.LEGGINGS, arg), new Item.Properties().fireResistant()
	);
	public static final Item NETHERITE_BOOTS = registerItem(
		"netherite_boots", arg -> new ArmorItem(ArmorMaterials.NETHERITE, ArmorType.BOOTS, arg), new Item.Properties().fireResistant()
	);
	...
	public static final Item PAINTING = registerItem("painting", arg -> new HangingEntityItem(EntityType.PAINTING, arg));
	...
	public static final Item OAK_SIGN = registerBlock(
		Blocks.OAK_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.OAK_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item SPRUCE_SIGN = registerBlock(
		Blocks.SPRUCE_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.SPRUCE_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item BIRCH_SIGN = registerBlock(
		Blocks.BIRCH_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.BIRCH_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item JUNGLE_SIGN = registerBlock(
		Blocks.JUNGLE_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.JUNGLE_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item ACACIA_SIGN = registerBlock(
		Blocks.ACACIA_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.ACACIA_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item CHERRY_SIGN = registerBlock(
		Blocks.CHERRY_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.CHERRY_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item DARK_OAK_SIGN = registerBlock(
		Blocks.DARK_OAK_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.DARK_OAK_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item PALE_OAK_SIGN = registerBlock(
		Blocks.PALE_OAK_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.PALE_OAK_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item MANGROVE_SIGN = registerBlock(
		Blocks.MANGROVE_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.MANGROVE_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item BAMBOO_SIGN = registerBlock(
		Blocks.BAMBOO_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.BAMBOO_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item CRIMSON_SIGN = registerBlock(
		Blocks.CRIMSON_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.CRIMSON_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item WARPED_SIGN = registerBlock(
		Blocks.WARPED_SIGN, (arg, arg2) -> new SignItem(arg, Blocks.WARPED_WALL_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item OAK_HANGING_SIGN = registerBlock(
		Blocks.OAK_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.OAK_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item SPRUCE_HANGING_SIGN = registerBlock(
		Blocks.SPRUCE_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.SPRUCE_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item BIRCH_HANGING_SIGN = registerBlock(
		Blocks.BIRCH_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.BIRCH_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item JUNGLE_HANGING_SIGN = registerBlock(
		Blocks.JUNGLE_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.JUNGLE_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item ACACIA_HANGING_SIGN = registerBlock(
		Blocks.ACACIA_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.ACACIA_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item CHERRY_HANGING_SIGN = registerBlock(
		Blocks.CHERRY_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.CHERRY_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item DARK_OAK_HANGING_SIGN = registerBlock(
		Blocks.DARK_OAK_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.DARK_OAK_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item PALE_OAK_HANGING_SIGN = registerBlock(
		Blocks.PALE_OAK_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.PALE_OAK_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item MANGROVE_HANGING_SIGN = registerBlock(
		Blocks.MANGROVE_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.MANGROVE_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item BAMBOO_HANGING_SIGN = registerBlock(
		Blocks.BAMBOO_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.BAMBOO_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item CRIMSON_HANGING_SIGN = registerBlock(
		Blocks.CRIMSON_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.CRIMSON_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item WARPED_HANGING_SIGN = registerBlock(
		Blocks.WARPED_HANGING_SIGN, (arg, arg2) -> new HangingSignItem(arg, Blocks.WARPED_WALL_HANGING_SIGN, arg2), new Item.Properties().stacksTo(16)
	);
	public static final Item BUCKET = registerItem("bucket", arg -> new BucketItem(Fluids.EMPTY, arg), new Item.Properties().stacksTo(16));
	public static final Item WATER_BUCKET = registerItem(
		"water_bucket", arg -> new BucketItem(Fluids.WATER, arg), new Item.Properties().craftRemainder(BUCKET).stacksTo(1)
	);
	public static final Item LAVA_BUCKET = registerItem(
		"lava_bucket", arg -> new BucketItem(Fluids.LAVA, arg), new Item.Properties().craftRemainder(BUCKET).stacksTo(1)
	);
	public static final Item POWDER_SNOW_BUCKET = registerItem(
		"powder_snow_bucket",
		arg -> new SolidBucketItem(Blocks.POWDER_SNOW, SoundEvents.BUCKET_EMPTY_POWDER_SNOW, arg),
	...
	public static final Item PUFFERFISH_BUCKET = registerItem(
		"pufferfish_bucket",
		arg -> new MobBucketItem(EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
	);
	public static final Item SALMON_BUCKET = registerItem(
		"salmon_bucket",
		arg -> new MobBucketItem(EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
	);
	public static final Item COD_BUCKET = registerItem(
		"cod_bucket",
		arg -> new MobBucketItem(EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
	);
	public static final Item TROPICAL_FISH_BUCKET = registerItem(
		"tropical_fish_bucket",
		arg -> new MobBucketItem(EntityType.TROPICAL_FISH, Fluids.WATER, SoundEvents.BUCKET_EMPTY_FISH, arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
	);
	public static final Item AXOLOTL_BUCKET = registerItem(
		"axolotl_bucket",
		arg -> new MobBucketItem(EntityType.AXOLOTL, Fluids.WATER, SoundEvents.BUCKET_EMPTY_AXOLOTL, arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
	);
	public static final Item TADPOLE_BUCKET = registerItem(
		"tadpole_bucket",
		arg -> new MobBucketItem(EntityType.TADPOLE, Fluids.WATER, SoundEvents.BUCKET_EMPTY_TADPOLE, arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUCKET_ENTITY_DATA, CustomData.EMPTY)
	);
	...
	public static final Item BUNDLE = registerItem(
		"bundle",
		arg -> new BundleItem(ResourceLocation.withDefaultNamespace("bundle_open_front"), ResourceLocation.withDefaultNamespace("bundle_open_back"), arg),
	...
	public static final Item WHITE_BUNDLE = registerItem(
		"white_bundle",
		arg -> new BundleItem(ResourceLocation.withDefaultNamespace("white_bundle_open_front"), ResourceLocation.withDefaultNamespace("white_bundle_open_back"), arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item ORANGE_BUNDLE = registerItem(
		"orange_bundle",
		arg -> new BundleItem(
			ResourceLocation.withDefaultNamespace("orange_bundle_open_front"), ResourceLocation.withDefaultNamespace("orange_bundle_open_back"), arg
		),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item MAGENTA_BUNDLE = registerItem(
		"magenta_bundle",
		arg -> new BundleItem(
			ResourceLocation.withDefaultNamespace("magenta_bundle_open_front"), ResourceLocation.withDefaultNamespace("magenta_bundle_open_back"), arg
		),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item LIGHT_BLUE_BUNDLE = registerItem(
		"light_blue_bundle",
		arg -> new BundleItem(
			ResourceLocation.withDefaultNamespace("light_blue_bundle_open_front"), ResourceLocation.withDefaultNamespace("light_blue_bundle_open_back"), arg
		),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item YELLOW_BUNDLE = registerItem(
		"yellow_bundle",
		arg -> new BundleItem(
			ResourceLocation.withDefaultNamespace("yellow_bundle_open_front"), ResourceLocation.withDefaultNamespace("yellow_bundle_open_back"), arg
		),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item LIME_BUNDLE = registerItem(
		"lime_bundle",
		arg -> new BundleItem(ResourceLocation.withDefaultNamespace("lime_bundle_open_front"), ResourceLocation.withDefaultNamespace("lime_bundle_open_back"), arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item PINK_BUNDLE = registerItem(
		"pink_bundle",
		arg -> new BundleItem(ResourceLocation.withDefaultNamespace("pink_bundle_open_front"), ResourceLocation.withDefaultNamespace("pink_bundle_open_back"), arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item GRAY_BUNDLE = registerItem(
		"gray_bundle",
		arg -> new BundleItem(ResourceLocation.withDefaultNamespace("gray_bundle_open_front"), ResourceLocation.withDefaultNamespace("gray_bundle_open_back"), arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item LIGHT_GRAY_BUNDLE = registerItem(
		"light_gray_bundle",
		arg -> new BundleItem(
			ResourceLocation.withDefaultNamespace("light_gray_bundle_open_front"), ResourceLocation.withDefaultNamespace("light_gray_bundle_open_back"), arg
		),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item CYAN_BUNDLE = registerItem(
		"cyan_bundle",
		arg -> new BundleItem(ResourceLocation.withDefaultNamespace("cyan_bundle_open_front"), ResourceLocation.withDefaultNamespace("cyan_bundle_open_back"), arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item PURPLE_BUNDLE = registerItem(
		"purple_bundle",
		arg -> new BundleItem(
			ResourceLocation.withDefaultNamespace("purple_bundle_open_front"), ResourceLocation.withDefaultNamespace("purple_bundle_open_back"), arg
		),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item BLUE_BUNDLE = registerItem(
		"blue_bundle",
		arg -> new BundleItem(ResourceLocation.withDefaultNamespace("blue_bundle_open_front"), ResourceLocation.withDefaultNamespace("blue_bundle_open_back"), arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item BROWN_BUNDLE = registerItem(
		"brown_bundle",
		arg -> new BundleItem(ResourceLocation.withDefaultNamespace("brown_bundle_open_front"), ResourceLocation.withDefaultNamespace("brown_bundle_open_back"), arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item GREEN_BUNDLE = registerItem(
		"green_bundle",
		arg -> new BundleItem(ResourceLocation.withDefaultNamespace("green_bundle_open_front"), ResourceLocation.withDefaultNamespace("green_bundle_open_back"), arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item RED_BUNDLE = registerItem(
		"red_bundle",
		arg -> new BundleItem(ResourceLocation.withDefaultNamespace("red_bundle_open_front"), ResourceLocation.withDefaultNamespace("red_bundle_open_back"), arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	public static final Item BLACK_BUNDLE = registerItem(
		"black_bundle",
		arg -> new BundleItem(ResourceLocation.withDefaultNamespace("black_bundle_open_front"), ResourceLocation.withDefaultNamespace("black_bundle_open_back"), arg),
		new Item.Properties().stacksTo(1).component(DataComponents.BUNDLE_CONTENTS, BundleContents.EMPTY)
	);
	...
	public static final Item WHITE_DYE = registerItem("white_dye", arg -> new DyeItem(DyeColor.WHITE, arg));
	public static final Item ORANGE_DYE = registerItem("orange_dye", arg -> new DyeItem(DyeColor.ORANGE, arg));
	public static final Item MAGENTA_DYE = registerItem("magenta_dye", arg -> new DyeItem(DyeColor.MAGENTA, arg));
	public static final Item LIGHT_BLUE_DYE = registerItem("light_blue_dye", arg -> new DyeItem(DyeColor.LIGHT_BLUE, arg));
	public static final Item YELLOW_DYE = registerItem("yellow_dye", arg -> new DyeItem(DyeColor.YELLOW, arg));
	public static final Item LIME_DYE = registerItem("lime_dye", arg -> new DyeItem(DyeColor.LIME, arg));
	public static final Item PINK_DYE = registerItem("pink_dye", arg -> new DyeItem(DyeColor.PINK, arg));
	public static final Item GRAY_DYE = registerItem("gray_dye", arg -> new DyeItem(DyeColor.GRAY, arg));
	public static final Item LIGHT_GRAY_DYE = registerItem("light_gray_dye", arg -> new DyeItem(DyeColor.LIGHT_GRAY, arg));
	public static final Item CYAN_DYE = registerItem("cyan_dye", arg -> new DyeItem(DyeColor.CYAN, arg));
	public static final Item PURPLE_DYE = registerItem("purple_dye", arg -> new DyeItem(DyeColor.PURPLE, arg));
	public static final Item BLUE_DYE = registerItem("blue_dye", arg -> new DyeItem(DyeColor.BLUE, arg));
	public static final Item BROWN_DYE = registerItem("brown_dye", arg -> new DyeItem(DyeColor.BROWN, arg));
	public static final Item GREEN_DYE = registerItem("green_dye", arg -> new DyeItem(DyeColor.GREEN, arg));
	public static final Item RED_DYE = registerItem("red_dye", arg -> new DyeItem(DyeColor.RED, arg));
	public static final Item BLACK_DYE = registerItem("black_dye", arg -> new DyeItem(DyeColor.BLACK, arg));
	...
	public static final Item CRAFTER = registerBlock(
		Blocks.CRAFTER, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	...
	public static final Item BREWING_STAND = registerBlock(
		Blocks.BREWING_STAND, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	...
	public static final Item ARMADILLO_SPAWN_EGG = registerItem("armadillo_spawn_egg", arg -> new SpawnEggItem(EntityType.ARMADILLO, 11366765, 8538184, arg));
	public static final Item ALLAY_SPAWN_EGG = registerItem("allay_spawn_egg", arg -> new SpawnEggItem(EntityType.ALLAY, 56063, 44543, arg));
	public static final Item AXOLOTL_SPAWN_EGG = registerItem("axolotl_spawn_egg", arg -> new SpawnEggItem(EntityType.AXOLOTL, 16499171, 10890612, arg));
	public static final Item BAT_SPAWN_EGG = registerItem("bat_spawn_egg", arg -> new SpawnEggItem(EntityType.BAT, 4996656, 986895, arg));
	public static final Item BEE_SPAWN_EGG = registerItem("bee_spawn_egg", arg -> new SpawnEggItem(EntityType.BEE, 15582019, 4400155, arg));
	public static final Item BLAZE_SPAWN_EGG = registerItem("blaze_spawn_egg", arg -> new SpawnEggItem(EntityType.BLAZE, 16167425, 16775294, arg));
	public static final Item BOGGED_SPAWN_EGG = registerItem("bogged_spawn_egg", arg -> new SpawnEggItem(EntityType.BOGGED, 9084018, 3231003, arg));
	public static final Item BREEZE_SPAWN_EGG = registerItem("breeze_spawn_egg", arg -> new SpawnEggItem(EntityType.BREEZE, 11506911, 9529055, arg));
	public static final Item CAT_SPAWN_EGG = registerItem("cat_spawn_egg", arg -> new SpawnEggItem(EntityType.CAT, 15714446, 9794134, arg));
	public static final Item CAMEL_SPAWN_EGG = registerItem("camel_spawn_egg", arg -> new SpawnEggItem(EntityType.CAMEL, 16565097, 13341495, arg));
	public static final Item CAVE_SPIDER_SPAWN_EGG = registerItem("cave_spider_spawn_egg", arg -> new SpawnEggItem(EntityType.CAVE_SPIDER, 803406, 11013646, arg));
	public static final Item CHICKEN_SPAWN_EGG = registerItem("chicken_spawn_egg", arg -> new SpawnEggItem(EntityType.CHICKEN, 10592673, 16711680, arg));
	public static final Item COD_SPAWN_EGG = registerItem("cod_spawn_egg", arg -> new SpawnEggItem(EntityType.COD, 12691306, 15058059, arg));
	public static final Item COW_SPAWN_EGG = registerItem("cow_spawn_egg", arg -> new SpawnEggItem(EntityType.COW, 4470310, 10592673, arg));
	public static final Item CREEPER_SPAWN_EGG = registerItem("creeper_spawn_egg", arg -> new SpawnEggItem(EntityType.CREEPER, 894731, 0, arg));
	public static final Item DOLPHIN_SPAWN_EGG = registerItem("dolphin_spawn_egg", arg -> new SpawnEggItem(EntityType.DOLPHIN, 2243405, 16382457, arg));
	public static final Item DONKEY_SPAWN_EGG = registerItem("donkey_spawn_egg", arg -> new SpawnEggItem(EntityType.DONKEY, 5457209, 8811878, arg));
	public static final Item DROWNED_SPAWN_EGG = registerItem("drowned_spawn_egg", arg -> new SpawnEggItem(EntityType.DROWNED, 9433559, 7969893, arg));
	public static final Item ELDER_GUARDIAN_SPAWN_EGG = registerItem(
		"elder_guardian_spawn_egg", arg -> new SpawnEggItem(EntityType.ELDER_GUARDIAN, 13552826, 7632531, arg)
	);
	public static final Item ENDER_DRAGON_SPAWN_EGG = registerItem(
		"ender_dragon_spawn_egg", arg -> new SpawnEggItem(EntityType.ENDER_DRAGON, 1842204, 14711290, arg)
	);
	public static final Item ENDERMAN_SPAWN_EGG = registerItem("enderman_spawn_egg", arg -> new SpawnEggItem(EntityType.ENDERMAN, 1447446, 0, arg));
	public static final Item ENDERMITE_SPAWN_EGG = registerItem("endermite_spawn_egg", arg -> new SpawnEggItem(EntityType.ENDERMITE, 1447446, 7237230, arg));
	public static final Item EVOKER_SPAWN_EGG = registerItem("evoker_spawn_egg", arg -> new SpawnEggItem(EntityType.EVOKER, 9804699, 1973274, arg));
	public static final Item FOX_SPAWN_EGG = registerItem("fox_spawn_egg", arg -> new SpawnEggItem(EntityType.FOX, 14005919, 13396256, arg));
	public static final Item FROG_SPAWN_EGG = registerItem("frog_spawn_egg", arg -> new SpawnEggItem(EntityType.FROG, 13661252, 16762748, arg));
	public static final Item GHAST_SPAWN_EGG = registerItem("ghast_spawn_egg", arg -> new SpawnEggItem(EntityType.GHAST, 16382457, 12369084, arg));
	public static final Item GLOW_SQUID_SPAWN_EGG = registerItem("glow_squid_spawn_egg", arg -> new SpawnEggItem(EntityType.GLOW_SQUID, 611926, 8778172, arg));
	public static final Item GOAT_SPAWN_EGG = registerItem("goat_spawn_egg", arg -> new SpawnEggItem(EntityType.GOAT, 10851452, 5589310, arg));
	public static final Item GUARDIAN_SPAWN_EGG = registerItem("guardian_spawn_egg", arg -> new SpawnEggItem(EntityType.GUARDIAN, 5931634, 15826224, arg));
	public static final Item HOGLIN_SPAWN_EGG = registerItem("hoglin_spawn_egg", arg -> new SpawnEggItem(EntityType.HOGLIN, 13004373, 6251620, arg));
	public static final Item HORSE_SPAWN_EGG = registerItem("horse_spawn_egg", arg -> new SpawnEggItem(EntityType.HORSE, 12623485, 15656192, arg));
	public static final Item HUSK_SPAWN_EGG = registerItem("husk_spawn_egg", arg -> new SpawnEggItem(EntityType.HUSK, 7958625, 15125652, arg));
	public static final Item IRON_GOLEM_SPAWN_EGG = registerItem("iron_golem_spawn_egg", arg -> new SpawnEggItem(EntityType.IRON_GOLEM, 14405058, 7643954, arg));
	public static final Item LLAMA_SPAWN_EGG = registerItem("llama_spawn_egg", arg -> new SpawnEggItem(EntityType.LLAMA, 12623485, 10051392, arg));
	public static final Item MAGMA_CUBE_SPAWN_EGG = registerItem("magma_cube_spawn_egg", arg -> new SpawnEggItem(EntityType.MAGMA_CUBE, 3407872, 16579584, arg));
	public static final Item MOOSHROOM_SPAWN_EGG = registerItem("mooshroom_spawn_egg", arg -> new SpawnEggItem(EntityType.MOOSHROOM, 10489616, 12040119, arg));
	public static final Item MULE_SPAWN_EGG = registerItem("mule_spawn_egg", arg -> new SpawnEggItem(EntityType.MULE, 1769984, 5321501, arg));
	public static final Item OCELOT_SPAWN_EGG = registerItem("ocelot_spawn_egg", arg -> new SpawnEggItem(EntityType.OCELOT, 15720061, 5653556, arg));
	public static final Item PANDA_SPAWN_EGG = registerItem("panda_spawn_egg", arg -> new SpawnEggItem(EntityType.PANDA, 15198183, 1776418, arg));
	public static final Item PARROT_SPAWN_EGG = registerItem("parrot_spawn_egg", arg -> new SpawnEggItem(EntityType.PARROT, 894731, 16711680, arg));
	public static final Item PHANTOM_SPAWN_EGG = registerItem("phantom_spawn_egg", arg -> new SpawnEggItem(EntityType.PHANTOM, 4411786, 8978176, arg));
	public static final Item PIG_SPAWN_EGG = registerItem("pig_spawn_egg", arg -> new SpawnEggItem(EntityType.PIG, 15771042, 14377823, arg));
	public static final Item PIGLIN_SPAWN_EGG = registerItem("piglin_spawn_egg", arg -> new SpawnEggItem(EntityType.PIGLIN, 10051392, 16380836, arg));
	public static final Item PIGLIN_BRUTE_SPAWN_EGG = registerItem(
		"piglin_brute_spawn_egg", arg -> new SpawnEggItem(EntityType.PIGLIN_BRUTE, 5843472, 16380836, arg)
	);
	public static final Item PILLAGER_SPAWN_EGG = registerItem("pillager_spawn_egg", arg -> new SpawnEggItem(EntityType.PILLAGER, 5451574, 9804699, arg));
	public static final Item POLAR_BEAR_SPAWN_EGG = registerItem("polar_bear_spawn_egg", arg -> new SpawnEggItem(EntityType.POLAR_BEAR, 15658718, 14014157, arg));
	public static final Item PUFFERFISH_SPAWN_EGG = registerItem("pufferfish_spawn_egg", arg -> new SpawnEggItem(EntityType.PUFFERFISH, 16167425, 3654642, arg));
	public static final Item RABBIT_SPAWN_EGG = registerItem("rabbit_spawn_egg", arg -> new SpawnEggItem(EntityType.RABBIT, 10051392, 7555121, arg));
	public static final Item RAVAGER_SPAWN_EGG = registerItem("ravager_spawn_egg", arg -> new SpawnEggItem(EntityType.RAVAGER, 7697520, 5984329, arg));
	public static final Item SALMON_SPAWN_EGG = registerItem("salmon_spawn_egg", arg -> new SpawnEggItem(EntityType.SALMON, 10489616, 951412, arg));
	public static final Item SHEEP_SPAWN_EGG = registerItem("sheep_spawn_egg", arg -> new SpawnEggItem(EntityType.SHEEP, 15198183, 16758197, arg));
	public static final Item SHULKER_SPAWN_EGG = registerItem("shulker_spawn_egg", arg -> new SpawnEggItem(EntityType.SHULKER, 9725844, 5060690, arg));
	public static final Item SILVERFISH_SPAWN_EGG = registerItem("silverfish_spawn_egg", arg -> new SpawnEggItem(EntityType.SILVERFISH, 7237230, 3158064, arg));
	public static final Item SKELETON_SPAWN_EGG = registerItem("skeleton_spawn_egg", arg -> new SpawnEggItem(EntityType.SKELETON, 12698049, 4802889, arg));
	public static final Item SKELETON_HORSE_SPAWN_EGG = registerItem(
		"skeleton_horse_spawn_egg", arg -> new SpawnEggItem(EntityType.SKELETON_HORSE, 6842447, 15066584, arg)
	);
	public static final Item SLIME_SPAWN_EGG = registerItem("slime_spawn_egg", arg -> new SpawnEggItem(EntityType.SLIME, 5349438, 8306542, arg));
	public static final Item SNIFFER_SPAWN_EGG = registerItem("sniffer_spawn_egg", arg -> new SpawnEggItem(EntityType.SNIFFER, 8855049, 2468720, arg));
	public static final Item SNOW_GOLEM_SPAWN_EGG = registerItem("snow_golem_spawn_egg", arg -> new SpawnEggItem(EntityType.SNOW_GOLEM, 14283506, 8496292, arg));
	public static final Item SPIDER_SPAWN_EGG = registerItem("spider_spawn_egg", arg -> new SpawnEggItem(EntityType.SPIDER, 3419431, 11013646, arg));
	public static final Item SQUID_SPAWN_EGG = registerItem("squid_spawn_egg", arg -> new SpawnEggItem(EntityType.SQUID, 2243405, 7375001, arg));
	public static final Item STRAY_SPAWN_EGG = registerItem("stray_spawn_egg", arg -> new SpawnEggItem(EntityType.STRAY, 6387319, 14543594, arg));
	public static final Item STRIDER_SPAWN_EGG = registerItem("strider_spawn_egg", arg -> new SpawnEggItem(EntityType.STRIDER, 10236982, 5065037, arg));
	public static final Item TADPOLE_SPAWN_EGG = registerItem("tadpole_spawn_egg", arg -> new SpawnEggItem(EntityType.TADPOLE, 7164733, 1444352, arg));
	public static final Item TRADER_LLAMA_SPAWN_EGG = registerItem(
		"trader_llama_spawn_egg", arg -> new SpawnEggItem(EntityType.TRADER_LLAMA, 15377456, 4547222, arg)
	);
	public static final Item TROPICAL_FISH_SPAWN_EGG = registerItem(
		"tropical_fish_spawn_egg", arg -> new SpawnEggItem(EntityType.TROPICAL_FISH, 15690005, 16775663, arg)
	);
	public static final Item TURTLE_SPAWN_EGG = registerItem("turtle_spawn_egg", arg -> new SpawnEggItem(EntityType.TURTLE, 15198183, 44975, arg));
	public static final Item VEX_SPAWN_EGG = registerItem("vex_spawn_egg", arg -> new SpawnEggItem(EntityType.VEX, 8032420, 15265265, arg));
	public static final Item VILLAGER_SPAWN_EGG = registerItem("villager_spawn_egg", arg -> new SpawnEggItem(EntityType.VILLAGER, 5651507, 12422002, arg));
	public static final Item VINDICATOR_SPAWN_EGG = registerItem("vindicator_spawn_egg", arg -> new SpawnEggItem(EntityType.VINDICATOR, 9804699, 2580065, arg));
	public static final Item WANDERING_TRADER_SPAWN_EGG = registerItem(
		"wandering_trader_spawn_egg", arg -> new SpawnEggItem(EntityType.WANDERING_TRADER, 4547222, 15377456, arg)
	);
	public static final Item WARDEN_SPAWN_EGG = registerItem("warden_spawn_egg", arg -> new SpawnEggItem(EntityType.WARDEN, 1001033, 3790560, arg));
	public static final Item WITCH_SPAWN_EGG = registerItem("witch_spawn_egg", arg -> new SpawnEggItem(EntityType.WITCH, 3407872, 5349438, arg));
	public static final Item WITHER_SPAWN_EGG = registerItem("wither_spawn_egg", arg -> new SpawnEggItem(EntityType.WITHER, 1315860, 5075616, arg));
	public static final Item WITHER_SKELETON_SPAWN_EGG = registerItem(
		"wither_skeleton_spawn_egg", arg -> new SpawnEggItem(EntityType.WITHER_SKELETON, 1315860, 4672845, arg)
	);
	public static final Item WOLF_SPAWN_EGG = registerItem("wolf_spawn_egg", arg -> new SpawnEggItem(EntityType.WOLF, 14144467, 13545366, arg));
	public static final Item ZOGLIN_SPAWN_EGG = registerItem("zoglin_spawn_egg", arg -> new SpawnEggItem(EntityType.ZOGLIN, 13004373, 15132390, arg));
	public static final Item CREAKING_SPAWN_EGG = registerItem("creaking_spawn_egg", arg -> new SpawnEggItem(EntityType.CREAKING, 6250335, 16545810, arg));
	public static final Item ZOMBIE_SPAWN_EGG = registerItem("zombie_spawn_egg", arg -> new SpawnEggItem(EntityType.ZOMBIE, 44975, 7969893, arg));
	public static final Item ZOMBIE_HORSE_SPAWN_EGG = registerItem(
		"zombie_horse_spawn_egg", arg -> new SpawnEggItem(EntityType.ZOMBIE_HORSE, 3232308, 9945732, arg)
	);
	public static final Item ZOMBIE_VILLAGER_SPAWN_EGG = registerItem(
		"zombie_villager_spawn_egg", arg -> new SpawnEggItem(EntityType.ZOMBIE_VILLAGER, 5651507, 7969893, arg)
	);
	public static final Item ZOMBIFIED_PIGLIN_SPAWN_EGG = registerItem(
		"zombified_piglin_spawn_egg", arg -> new SpawnEggItem(EntityType.ZOMBIFIED_PIGLIN, 15373203, 5009705, arg)
	);
	...
	public static final Item ITEM_FRAME = registerItem("item_frame", arg -> new ItemFrameItem(EntityType.ITEM_FRAME, arg));
	public static final Item GLOW_ITEM_FRAME = registerItem("glow_item_frame", arg -> new ItemFrameItem(EntityType.GLOW_ITEM_FRAME, arg));
	...
	public static final Item SKELETON_SKULL = registerBlock(
		...
		(arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.SKELETON_WALL_SKULL, Direction.DOWN, arg2),
	...
	public static final Item WITHER_SKELETON_SKULL = registerBlock(
		...
		(arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.WITHER_SKELETON_WALL_SKULL, Direction.DOWN, arg2),
	...
	public static final Item PLAYER_HEAD = registerBlock(
		Blocks.PLAYER_HEAD,
		(arg, arg2) -> new PlayerHeadItem(arg, Blocks.PLAYER_WALL_HEAD, arg2),
		new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
	);
	public static final Item ZOMBIE_HEAD = registerBlock(
		Blocks.ZOMBIE_HEAD,
		(arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.ZOMBIE_WALL_HEAD, Direction.DOWN, arg2),
		new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
	);
	public static final Item CREEPER_HEAD = registerBlock(
		Blocks.CREEPER_HEAD,
		(arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.CREEPER_WALL_HEAD, Direction.DOWN, arg2),
		new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
	);
	public static final Item DRAGON_HEAD = registerBlock(
		Blocks.DRAGON_HEAD,
		(arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.DRAGON_WALL_HEAD, Direction.DOWN, arg2),
	...
	public static final Item PIGLIN_HEAD = registerBlock(
		Blocks.PIGLIN_HEAD,
		(arg, arg2) -> new StandingAndWallBlockItem(arg, Blocks.PIGLIN_WALL_HEAD, Direction.DOWN, arg2),
		new Item.Properties().rarity(Rarity.UNCOMMON).equippableUnswappable(EquipmentSlot.HEAD)
	);
	...
	public static final Item IRON_HORSE_ARMOR = registerItem(
		"iron_horse_armor",
		arg -> new AnimalArmorItem(ArmorMaterials.IRON, AnimalArmorItem.BodyType.EQUESTRIAN, SoundEvents.HORSE_ARMOR, false, arg),
		new Item.Properties().stacksTo(1)
	);
	public static final Item GOLDEN_HORSE_ARMOR = registerItem(
		"golden_horse_armor",
		arg -> new AnimalArmorItem(ArmorMaterials.GOLD, AnimalArmorItem.BodyType.EQUESTRIAN, SoundEvents.HORSE_ARMOR, false, arg),
		new Item.Properties().stacksTo(1)
	);
	public static final Item DIAMOND_HORSE_ARMOR = registerItem(
		"diamond_horse_armor",
		arg -> new AnimalArmorItem(ArmorMaterials.DIAMOND, AnimalArmorItem.BodyType.EQUESTRIAN, SoundEvents.HORSE_ARMOR, false, arg),
		new Item.Properties().stacksTo(1)
	);
	public static final Item LEATHER_HORSE_ARMOR = registerItem(
		"leather_horse_armor",
		arg -> new AnimalArmorItem(ArmorMaterials.LEATHER, AnimalArmorItem.BodyType.EQUESTRIAN, SoundEvents.HORSE_ARMOR, false, arg),
		new Item.Properties().stacksTo(1)
	);
	...
	public static final Item COMMAND_BLOCK_MINECART = registerItem(
		"command_block_minecart", arg -> new MinecartItem(EntityType.COMMAND_BLOCK_MINECART, arg), new Item.Properties().stacksTo(1).rarity(Rarity.EPIC)
	);
	...
	public static final Item WHITE_BANNER = registerBlock(
		Blocks.WHITE_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.WHITE_WALL_BANNER, arg2),
	...
	public static final Item ORANGE_BANNER = registerBlock(
		...
		(arg, arg2) -> new BannerItem(arg, Blocks.ORANGE_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item MAGENTA_BANNER = registerBlock(
		Blocks.MAGENTA_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.MAGENTA_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item LIGHT_BLUE_BANNER = registerBlock(
		Blocks.LIGHT_BLUE_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.LIGHT_BLUE_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item YELLOW_BANNER = registerBlock(
		Blocks.YELLOW_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.YELLOW_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item LIME_BANNER = registerBlock(
		Blocks.LIME_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.LIME_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item PINK_BANNER = registerBlock(
		Blocks.PINK_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.PINK_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item GRAY_BANNER = registerBlock(
		Blocks.GRAY_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.GRAY_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item LIGHT_GRAY_BANNER = registerBlock(
		Blocks.LIGHT_GRAY_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.LIGHT_GRAY_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item CYAN_BANNER = registerBlock(
		Blocks.CYAN_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.CYAN_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item PURPLE_BANNER = registerBlock(
		Blocks.PURPLE_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.PURPLE_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item BLUE_BANNER = registerBlock(
		Blocks.BLUE_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.BLUE_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item BROWN_BANNER = registerBlock(
		Blocks.BROWN_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.BROWN_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item GREEN_BANNER = registerBlock(
		Blocks.GREEN_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.GREEN_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item RED_BANNER = registerBlock(
		Blocks.RED_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.RED_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	public static final Item BLACK_BANNER = registerBlock(
		Blocks.BLACK_BANNER,
		(arg, arg2) -> new BannerItem(arg, Blocks.BLACK_WALL_BANNER, arg2),
		new Item.Properties().stacksTo(16).component(DataComponents.BANNER_PATTERNS, BannerPatternLayers.EMPTY)
	);
	...
	public static final Item FLOWER_BANNER_PATTERN = registerItem(
		"flower_banner_pattern", arg -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_FLOWER, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item CREEPER_BANNER_PATTERN = registerItem(
		"creeper_banner_pattern",
		arg -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_CREEPER, arg),
		new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)
	);
	public static final Item SKULL_BANNER_PATTERN = registerItem(
		"skull_banner_pattern", arg -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_SKULL, arg), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)
	);
	public static final Item MOJANG_BANNER_PATTERN = registerItem(
		"mojang_banner_pattern", arg -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_MOJANG, arg), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)
	);
	public static final Item GLOBE_BANNER_PATTERN = registerItem(
		"globe_banner_pattern", arg -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_GLOBE, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item PIGLIN_BANNER_PATTERN = registerItem(
		"piglin_banner_pattern", arg -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_PIGLIN, arg), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON)
	);
	public static final Item FLOW_BANNER_PATTERN = registerItem(
		"flow_banner_pattern", arg -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_FLOW, arg), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)
	);
	public static final Item GUSTER_BANNER_PATTERN = registerItem(
		"guster_banner_pattern", arg -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_GUSTER, arg), new Item.Properties().stacksTo(1).rarity(Rarity.RARE)
	);
	public static final Item FIELD_MASONED_BANNER_PATTERN = registerItem(
		"field_masoned_banner_pattern", arg -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_FIELD_MASONED, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item BORDURE_INDENTED_BANNER_PATTERN = registerItem(
		"bordure_indented_banner_pattern", arg -> new BannerPatternItem(BannerPatternTags.PATTERN_ITEM_BORDURE_INDENTED, arg), new Item.Properties().stacksTo(1)
	);
	public static final Item GOAT_HORN = registerItem(
		"goat_horn", arg -> new InstrumentItem(InstrumentTags.GOAT_HORNS, arg), new Item.Properties().rarity(Rarity.UNCOMMON).stacksTo(1)
	);
	public static final Item COMPOSTER = registerBlock(Blocks.COMPOSTER);
	public static final Item BARREL = registerBlock(
		Blocks.BARREL, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	public static final Item SMOKER = registerBlock(
		Blocks.SMOKER, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	public static final Item BLAST_FURNACE = registerBlock(
		Blocks.BLAST_FURNACE, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	...
	public static final Item CAMPFIRE = registerBlock(
		Blocks.CAMPFIRE, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	public static final Item SOUL_CAMPFIRE = registerBlock(
		Blocks.SOUL_CAMPFIRE, (UnaryOperator<Item.Properties>)(arg -> arg.component(DataComponents.CONTAINER, ItemContainerContents.EMPTY))
	);
	...
	private static Function<Item.Properties, Item> createBlockItemWithCustomItemName(Block arg) {
		return arg2 -> new BlockItem(arg, arg2.useItemDescriptionPrefix());
	}
	...
	private static ResourceKey<Item> blockIdToItemId(ResourceKey<Block> arg) {
		return ResourceKey.create(Registries.ITEM, arg.location());
	}

	public static Item registerBlock(Block arg) {
		return registerBlock(arg, BlockItem::new);
	}

	public static Item registerBlock(Block arg, Item.Properties arg2) {
		return registerBlock(arg, BlockItem::new, arg2);
	}

	public static Item registerBlock(Block arg, UnaryOperator<Item.Properties> unaryOperator) {
		return registerBlock(arg, (BiFunction<Block, Item.Properties, Item>)((argx, arg2) -> new BlockItem(argx, (Item.Properties)unaryOperator.apply(arg2))));
	}

	public static Item registerBlock(Block arg, Block... args) {
		return registerItem(blockIdToItemId(arg.builtInRegistryHolder().key()), p -> new BlockItem(arg, p) {
			@Override
	...
	public static Item registerBlock(Block arg, BiFunction<Block, Item.Properties, Item> biFunction) {
		return registerBlock(arg, biFunction, new Item.Properties());
	}

	public static Item registerBlock(Block arg, BiFunction<Block, Item.Properties, Item> biFunction, Item.Properties arg2) {
		return registerItem(blockIdToItemId(arg.builtInRegistryHolder().key()), arg2x -> (Item)biFunction.apply(arg, arg2x), arg2.useBlockDescriptionPrefix());
	}
	...
	public static Item registerItem(String string, Function<Item.Properties, Item> function, Item.Properties arg) {
		return registerItem(vanillaItemId(string), function, arg);
	}

	public static Item registerItem(String string, Item.Properties arg) {
		return registerItem(vanillaItemId(string), Item::new, arg);
	}
	...
	public static Item registerItem(ResourceKey<Item> arg, Function<Item.Properties, Item> function) {
		return registerItem(arg, function, new Item.Properties());
	}

	public static Item registerItem(ResourceKey<Item> arg, Function<Item.Properties, Item> function, Item.Properties arg2) {
		Item item = (Item)function.apply(arg2.setId(arg));
		if (item instanceof BlockItem blockitem) {
			blockitem.registerBlocks(Item.BY_BLOCK, item);
		}

		return Registry.register(BuiltInRegistries.ITEM, arg, item);
	}
}
