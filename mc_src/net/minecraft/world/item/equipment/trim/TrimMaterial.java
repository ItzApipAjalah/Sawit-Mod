...
public record TrimMaterial(
	...
	public static TrimMaterial create(String string, Item arg, float f, Component arg2, Map<ResourceLocation, String> map) {
		return new TrimMaterial(string, BuiltInRegistries.ITEM.wrapAsHolder(arg), f, map, arg2);
	}
}
