...
public class SnowballItem extends Item implements ProjectileItem {
	public SnowballItem(Item.Properties arg) {
		super(arg);
	}
	...
	public InteractionResult use(Level arg, Player arg2, InteractionHand arg3) {
		...
		arg.playSound(
			null, arg2.getX(), arg2.getY(), arg2.getZ(), SoundEvents.SNOWBALL_THROW, SoundSource.NEUTRAL, 0.5F, 0.4F / (arg.getRandom().nextFloat() * 0.4F + 0.8F)
		);
		if (arg instanceof ServerLevel serverLevel) {
			Projectile.spawnProjectileFromRotation(Snowball::new, serverLevel, itemStack, arg2, 0.0F, 1.5F, 1.0F);
		}
	...
	public Projectile asProjectile(Level arg, Position arg2, ItemStack arg3, Direction arg4) {
		return new Snowball(arg, arg2.x(), arg2.y(), arg2.z(), arg3);
	}
}
