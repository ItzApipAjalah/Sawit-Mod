...
public class Potions {
	...
	private static Holder<Potion> register(String string, Potion arg) {
		return Registry.registerForHolder(BuiltInRegistries.POTION, ResourceLocation.withDefaultNamespace(string), arg);
	}

	public static Holder<Potion> bootstrap(Registry<Potion> arg) {
		return WATER;
	}
}
