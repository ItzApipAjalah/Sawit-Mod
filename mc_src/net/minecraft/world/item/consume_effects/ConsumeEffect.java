...
public interface ConsumeEffect {
	...
	boolean apply(Level arg, ItemStack arg2, LivingEntity arg3);
	...
	public record Type<T extends ConsumeEffect>(MapCodec<T> codec, StreamCodec<RegistryFriendlyByteBuf, T> streamCodec) {
		...
		private static <T extends ConsumeEffect> ConsumeEffect.Type<T> register(String string, MapCodec<T> mapCodec, StreamCodec<RegistryFriendlyByteBuf, T> arg) {
			return Registry.register(BuiltInRegistries.CONSUME_EFFECT_TYPE, string, new ConsumeEffect.Type<>(mapCodec, arg));
		}
	}
}
