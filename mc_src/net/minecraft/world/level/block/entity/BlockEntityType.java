...
public class BlockEntityType<T extends BlockEntity> {
	...
	@Nullable
	public static ResourceLocation getKey(BlockEntityType<?> arg) {
		return BuiltInRegistries.BLOCK_ENTITY_TYPE.getKey(arg);
	}

	private static <T extends BlockEntity> BlockEntityType<T> register(String string, BlockEntityType.BlockEntitySupplier<? extends T> arg, Block... args) {
		if (args.length == 0) {
		...
		return Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, string, new BlockEntityType<>(arg, Set.of(args)));
	}

	public BlockEntityType(BlockEntityType.BlockEntitySupplier<? extends T> arg, Set<Block> set) {
		this.factory = arg;
		this.validBlocks = set;
	}

	public BlockEntityType(BlockEntityType.BlockEntitySupplier<? extends T> arg, Block... args) {
		this(arg, Set.of(args));
		if (args.length == 0) {
	...
	@Nullable
	public T create(BlockPos arg, BlockState arg2) {
		return (T)this.factory.create(arg, arg2);
	}
	...
	public boolean isValid(BlockState arg) {
		return this.validBlocks.contains(arg.getBlock());
	}
	...
	@Nullable
	public T getBlockEntity(BlockGetter arg, BlockPos arg2) {
	...
	public interface BlockEntitySupplier<T extends BlockEntity> {
		T create(BlockPos arg, BlockState arg2);
	}
}
