...
public class BoatModel extends AbstractBoatModel {
	...
	public BoatModel(ModelPart arg) {
		super(arg);
	}

	private static void addCommonParts(PartDefinition arg) {
		int i = 16;
		int j = 14;
		int k = 10;
		arg.addOrReplaceChild(
			"bottom",
		...
		arg.addOrReplaceChild("left", CubeListBuilder.create().texOffs(0, 43).addBox(-14.0F, -7.0F, -1.0F, 28.0F, 6.0F, 2.0F), PartPose.offset(0.0F, 4.0F, 9.0F));
		int l = 20;
		int m = 7;
		int n = 6;
		float f = -5.0F;
