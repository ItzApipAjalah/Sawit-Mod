...
public class ModelLayers {
	...
	public static ModelLayerLocation createStandingSignModelName(WoodType arg) {
		ResourceLocation location = ResourceLocation.parse(arg.name());
		return new ModelLayerLocation(location.withPrefix("sign/standing/"), "main");
	}

	public static ModelLayerLocation createWallSignModelName(WoodType arg) {
		ResourceLocation location = ResourceLocation.parse(arg.name());
		return new ModelLayerLocation(location.withPrefix("sign/wall/"), "main");
	}

	public static ModelLayerLocation createHangingSignModelName(WoodType arg) {
		ResourceLocation location = ResourceLocation.parse(arg.name());
